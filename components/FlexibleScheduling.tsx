      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-professional-gray max-w-4xl mx-auto leading-relaxed">
            One of the biggest advantages of booking a home massage (pijat) in Kuta is flexibility. Every traveler's schedule 
            is different. Some want to start the day with fresh energy, others need to recover after a long surf session, 
            and many prefer to end their evening with deep relaxation. That's why we're available from 07:00 until 22:00, 
            seven days a week — to fit into your lifestyle and maximize both relaksasi and kualitas tidur.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <Card className="bg-gradient-subtle border-0 shadow-floating hover:shadow-elevated transition-all duration-300 text-center">
            <CardContent className="p-8">
              ...
              <h3 className="text-xl font-bold text-professional-navy mb-4">Morning Energy (07:00 - 11:00)</h3>
              <p className="text-professional-gray leading-relaxed">
                For early risers, a morning massage (pijat) is the perfect way to start the day. Imagine waking up in your villa, 
          ...
          <Card className="bg-gradient-subtle border-0 shadow-floating hover:shadow-elevated transition-all duration-300 text-center">
            <CardContent className="p-8">
              ...
              <h3 className="text-xl font-bold text-professional-navy mb-4">Midday Recovery (12:00 - 18:00)</h3>
              <p className="text-professional-gray leading-relaxed">
                ...
                can get back in the ocean the next day without nyeri.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-subtle border-0 shadow-floating hover:shadow-elevated transition-all duration-300 text-center">
            <CardContent className="p-8">
              ...
              <h3 className="text-xl font-bold text-professional-navy mb-4">Evening Relaxation (19:00 - 22:00)</h3>
              <p className="text-professional-gray leading-relaxed">
                And for night owls, evening is the magic time. Kuta's nightlife is famous, but not everyone wants to 
                end their evening at a bar. Booking a massage at 21:00 lets you relax fully, unwind from the day, and 
                prepare for restful sleep, ensuring improved kualitas tidur.
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="bg-gradient-professional rounded-2xl p-8 lg:p-12 shadow-elevated text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Our 07:00 – 22:00 availability in Kuta gives you freedom. Morning, afternoon, or night — wellness is 
              always within reach, right in the comfort of your villa or hotel.
            </p>
            
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold mb-2">07:00</div>
              ...
              <div className="text-center">
                <div className="text-3xl font-bold mb-2">22:00</div>
