                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <Button
                      ...
                      className={`h-auto p-4 flex flex-col items-center gap-2 ${bookingType === "asap" ? "" : "text-professional-navy border-professional-navy"
                        }`}
                    ...
                    <Button
                      ...
                      className={`h-auto p-4 flex flex-col items-center gap-2 ${bookingType === "schedule" ? "" : "text-professional-navy border-professional-navy"
                        }`}
